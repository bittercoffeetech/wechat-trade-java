...
public final class TradeRefundCouponInfo implements Serializable {
	 ...
	 * 代金券ID
	 */
	@ApiField(name = "coupon_refund_id")
	@JsonProperty("coupon_refund_id")
	private String id;
	...
	public TradeRefundCouponInfo() {

	}

	public TradeRefundCouponInfo(String id, CouponTypeEnum type, long fee) {
		super();
		this.id = id;
		this.type = type;
		this.fee = fee;
